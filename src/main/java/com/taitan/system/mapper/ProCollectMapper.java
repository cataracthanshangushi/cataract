...
public interface ProCollectMapper extends BaseMapper<ProCollect> {
    ...
    @Select("select b.id,b.user_id,b.product_name,b.contact_id,b.cover,b.category,b.subheading " +
            "from pro_collect a LEFT JOIN product_detail b ON a.pro_id=b.id WHERE b.online=1 and a.user_id=#{userId}")
